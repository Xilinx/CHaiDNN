...
void stgRowCount(int *scalar_conv_args)
{
	...
	if( (scalar_conv_args[34] != OPCODE_POOL2CONV) && (scalar_conv_args[34] != OPCODE_AVRPOOL2CONV) )  //otherthan pool split
	{
		if(stgcount < 1)
		{
			...
			fprintf(stderr, "        Increase XI_ISTAGEBUFF_DEPTH in design/conv/include/xi_conv_config.h.\n");
		...
		if(ostgcount < 1)
		{
			...
			fprintf(stderr, "        Increase XI_OSTAGEBUFF_DEPTH in software/include/hw_settings.h.\n");
